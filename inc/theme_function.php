...
// Header Logo Img Show Admin
$wp_customize->add_section('sectionL',array(
'title' => __('Header Logo Area','alihossain'),
'description' => 'This is the header area'
));
$wp_customize->add_setting('settingL',array(
'default' => get_bloginfo('template_directory') . '/img/logo.png',

));
$wp_customize-> add_control(new WP_Customize_Image_Control($wp_customize,'settingL',array(
'label' => 'Logo Upload Now',
'description' => 'Change YOur Favoriet Now',
'section'=>'sectionL',
'setting'=>'settingL'
)));
  ...
  //   ),
  // ));
$wp_customize->add_section('sectionP',array(
'title' => 'Menu Position Set',
'description'=>'If YOu Want TO Change YOur Menu Position'
));
$wp_customize->add_setting('settingP',array(
   'default' => 'right_menu',
));
$wp_customize->add_control('settingP',array(
