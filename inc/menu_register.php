...
add_filter('walker_nav_menu_start_el', 'ali_nav_description', 10, 2);
//ba eita
//function ali_nav_description( $item_output, $item){
//  if( !empty ($item->description)){
//$item_output=str_replace('</a>', '<span class="walker-nav">'.$item->description .'</span>'. '</a>',$item_output);
//}
//return $item_output;
//}
//
